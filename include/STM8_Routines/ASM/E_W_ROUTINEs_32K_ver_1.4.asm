...
Loaded hexfile E_W_ROUTINEs_32K_ver_1.4.hex from 0x00a0 to 0x01cf
...
0x00a3:  3f 96          clr $96                                  cycles=1
0x00a5:  72 09 00 8e 16 btjf $8e, #4, $c0  (offset=22)           cycles=2-3
0x00aa:  cd 60 63       call $6063                               cycles=4
...
0x00db:  cd 60 63       call $6063                               cycles=4
...
0x0119:  72 10 00 96    bset $96, #0                             cycles=1
...
0x0139:  20 85          jra $c0  (offset=-123)                   cycles=2
0x013b:  9d             nop                                      cycles=1
...
0x0150:  cd 60 63       call $6063                               cycles=4
0x0153:  5f             clrw X                                   cycles=1
0x0154:  3f 97          clr $97                                  cycles=1
...
0x0175:  f6             ld A, (X)                                cycles=1
0x0176:  92 a7 00 8a    ldf ([$8a.e],X),A                        cycles=4
0x017a:  72 0c 00 8e 13 btjt $8e, #6, $192  (offset=19)          cycles=2-3
0x017f:  72 00 50 5f 07 btjt $505f, #0, $18b  (offset=7)         cycles=2-3
0x0184:  72 05 50 5f fb btjf $505f, #2, $184  (offset=-5)        cycles=2-3
0x0189:  20 04          jra $18f  (offset=4)                     cycles=2
0x018b:  72 10 00 97    bset $97, #0                             cycles=1
0x018f:  cd 60 63       call $6063                               cycles=4
0x0192:  9f             ld A, XL                                 cycles=1
0x0193:  b1 88          cp A, $88                                cycles=1
0x0195:  27 03          jreq $19a  (offset=3)                    cycles=1-2
0x0197:  5c             incw X                                   cycles=1
0x0198:  20 db          jra $175  (offset=-37)                   cycles=2
0x019a:  72 0d 00 8e 10 btjf $8e, #6, $1af  (offset=16)          cycles=2-3
0x019f:  72 00 50 5f 07 btjt $505f, #0, $1ab  (offset=7)         cycles=2-3
0x01a4:  72 05 50 5f fb btjf $505f, #2, $1a4  (offset=-5)        cycles=2-3
0x01a9:  20 24          jra $1cf  (offset=36)                    cycles=2
0x01ab:  72 10 00 97    bset $97, #0                             cycles=1
0x01af:  20 1e          jra $1cf  (offset=30)                    cycles=2
0x01b1:  9d             nop                                      cycles=1
0x01b2:  9d             nop                                      cycles=1
0x01b3:  9d             nop                                      cycles=1
