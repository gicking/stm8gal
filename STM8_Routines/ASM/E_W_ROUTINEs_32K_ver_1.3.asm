...
Loaded hexfile E_W_ROUTINEs_32K_ver_1.3.hex from 0x00a0 to 0x01cf
...
0x00aa:  cd 60 65       call $6065                               cycles=4
...
0x00db:  cd 60 65       call $6065                               cycles=4
...
0x0150:  cd 60 65       call $6065                               cycles=4
...
0x018f:  cd 60 65       call $6065                               cycles=4
