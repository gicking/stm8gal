...
Loaded hexfile E_W_ROUTINEs_128K_ver_2.1.hex from 0x00a0 to 0x01ff
...
0x00a3:  3f 9c          clr $9c                                  cycles=1
0x00a5:  72 09 00 8e 16 btjf $8e, #4, $c0  (offset=22)           cycles=2-3
0x00aa:  cd 60 8c       call $608c                               cycles=4
...
0x010c:  cd 60 8c       call $608c                               cycles=4
...
0x014a:  72 10 00 9c    bset $9c, #0                             cycles=1
...
0x0180:  cd 60 8c       call $608c                               cycles=4
0x0183:  5f             clrw X                                   cycles=1
0x0184:  3f 9d          clr $9d                                  cycles=1
...
0x01bb:  72 10 00 9d    bset $9d, #0                             cycles=1
0x01bf:  cd 60 8c       call $608c                               cycles=4
...
0x01db:  72 10 00 9d    bset $9d, #0                             cycles=1
