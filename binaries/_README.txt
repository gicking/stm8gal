...
stm8gal_linux64: 
  ...
  - with -DUSE_SPI_ARDUINO -> support upload via Arduino USB<->SPI bridge. See Makefile
  - without -DUSE_SPIDEV   -> no support upload via direct SPI. See Makefile
...
stm8gal_raspbian32
  ...
  - with -DUSE_SPI_ARDUINO -> support upload via Arduino USB<->SPI bridge. See Makefile
  - without -DUSE_SPIDEV   -> no support upload via SPI. See Makefile
